...
\documentclass[12pt]{HITletter} % use HITletter.cls definitions
\usepackage{fontspec} 
\usepackage{tikz} 
\usepackage{xcolor}
	\definecolor{HITblue}{RGB}{0, 33, 165}
\usepackage{lipsum}
\usepackage{fancyhdr}
\usepackage{lastpage}
\usepackage{eso-pic}
...
\begin{tikzpicture}
    ...
    {\includegraphics[width=1\textwidth]{monogram.png}};
    \end{tikzpicture}
\vfill}}}
...
\def\Address{1661 NE 57th Street \\ Ft. Lauderdale, FL 33334} 
%
% Set your HIT e-mail here
\def\Email{\textbf{\color{HITblue}E-mail}:\\ lucas.james.greenwood@gmail.com}
%
% Set your preferred contact number here
\def\TEL{\textbf{\color{HITblue}Phone}: +1 954 478 5191}
%
% Set your department or personal website here
% \def\URL{\textbf{\color{HITblue}URL}: http://lucasgreenwood.com XXX}
%
%%%%%%%%%%%%%%%%  Footer information  %%%%%%%%%%%%%%%%%%
%
...
%
\date{\vspace{10mm} November 16, 2024}
...
\begin{letter}{
                Sir. Hiring Manager\\ 
                \textbf{Academic and/or Institution}\\ 
                Post Address\\
                Dept.\\
                Uni\\
                Uni Location\\
